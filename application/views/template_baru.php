   ...
   <!-- <div class="navbar-header">
    ...
    <div>
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo site_url("baru_daftar"); ?>">PENDAFTARAN</a></li>
      <?php if($userdata['user_level'] > 2) :  ?>
        <li><a href="<?php echo site_url("baru_bukablokir/list_buka_blokir"); ?>">BUKA BLOKIR</a></li>
		  <?php endif; ?>
     <li><a href="<?php echo site_url("baru_cek"); ?>">CEK STATUS</a></li>
        <li><a href="<?php echo site_url("baru_cabang"); ?>">KANTOR CABANG</a></li>
        <?php if($userdata['user_level'] > 1) :  ?>

        <li><a href="<?php echo site_url("baru_verifikasi"); ?>">VERIFIKASI</a></li>
      <?php endif; ?>
     <!--    <li><a href="#">SETTING</a></li>
        <li><a href="<?php echo site_url("login/logout"); ?>">LOGOUT</a></li> -->
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo site_url("baru_laporan"); ?>">LAPORAN BLOKIR KENDARAAN</a></li>
       ...
       <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#">LEASING : <?php echo $userdata['leasing_nama_singkatan']; ?></a></li>
        <li class="dropdown">
