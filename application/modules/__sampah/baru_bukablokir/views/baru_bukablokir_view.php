...
<div class="col-md-8">
		<div class="panel panel-default">
            <div class="panel-heading">DETAIL KENDARAAN DAN BLOKIR</div>
            <div class="panel-body">
...
<div class="col-md-4">
		<div class="panel panel-default">
            ...
            <div class="panel-body">
               <form id="bukablokir" method="post" >
               <input type="hidden" name="daft_id" id="daft_id" />
            	Alasan Buka Blokir
                <input type="text" class="form-control"  
                        id="alasan" placeholder="ALASAN BLOKIR"
                        name="alasan"><br />
                Nomor Surat Permohonan
                <input type="text" class="form-control"  
                        id="surat_no" placeholder="Nomor Surat Permohonan"
                        name="surat_no"><br />
                 Tanggal Surat Permohonan
                <input type="text" class="form-control"  
                        id="surat_tgl" placeholder="Tanggal "
                        name="surat_tgl"  data-date-format="dd-mm-yyyy"><br />        
                 Nomor Surat Referensi
                <input type="text" class="form-control"  
                        id="surat_ref_no" placeholder="Nomor Surat Permohonan"
                        name="surat_ref_no"><br />
                    
                        
                        
                 <input class="btn btn-md btn-success btn-block" 
                        type="submit" value="BUKA BLOKIR">
                 </form>
            </div>
         </div>
</div>
