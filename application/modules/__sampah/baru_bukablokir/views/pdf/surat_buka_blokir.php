...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
  ...
  <tr>
    <td colspan="2" align="center" valign="top">Nomor : KET/<?php echo $daft_id."/".date("Y")."/DITLANTAS";?></td>
  </tr>
  <tr>
...
<?php echo $no_bpkb; ?> dan No. Reg <?php echo $nreg_bpkb; ?> dimaksud Benar dikeluarkan / terdaftar dan telah diblokir SIE BPKB DITLANTAS <?php echo  $nama_polda_singkatan; ?> atas permintaan <?php echo  $leasing_nama; ?> <?php echo  $leasing_alamat; ?> pada tanggal <?php echo  tgl_indo($tgl_blokir); ?> dengan nomor surat <?php echo $no_surat; ?> pemblokiran kendaraan tersebut <strong>DIBUKA KEMBALI</strong>. </p>
