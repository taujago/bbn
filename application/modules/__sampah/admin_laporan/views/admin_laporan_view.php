...
<div class="col-md-12">
		<div class="panel panel-default">
            ...
            <form class="form-horizontal"  id="fuckyouform">
            <div class="col-md-6">
                    <div class="form-group">
                      <label class="col-sm-4 control-label" for="leasing_id">Leasing</label>
                      <div class="col-sm-8">
                        <?php 
                    ...
                    <div class="form-group">
                      <label class="col-sm-4 control-label" for="id_polda">Polda</label>
                       <div class="col-sm-8">
                      <?php 
					   	echo form_dropdown('id_polda',array(),array("x"=>"== PILIH POLDA =="),'id="id_polda" class="form-control"');
					   ?> 
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="col-sm-4 control-label" for="jenis_permohonan">Jenis Permohonan</label>
                      <div class="col-sm-8">
                        <?php 
					   	echo form_dropdown('jenis_permohonan',$arr_jenis_permohonan,'','id="jenis_permohonan" class="form-control"');
					   ?> 
                      </div>
            ...
            <div class="col-md-6">
                    <div class="form-group">
                      <label class="col-sm-5 control-label" for="tanggal_awal">Tanggal Awal</label>
                      <div class="col-sm-7">
                    ...
                    <div class="form-group">
                      <label class="col-sm-5 control-label" for="tanggal_akhir">Tanggal Akhir</label>
                       <div class="col-sm-7">
                       <input type="text" class="form-control" 
                    ...
                    <div class="form-group">
                      <label class="col-sm-5 control-label" for="no_rangka">No. RANGKA / BPKB</label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control"   
          ...
          <!-- 
                <form class="form-inline" id="fuckyouform">
                      ...
                      <?php 
                       ...
                       <div class="form-group">
                       <?php 
					   	echo form_dropdown('jenis_permohonan',$arr_jenis_permohonan,'','id="jenis_permohonan" class="form-control" style="width:300px;"');
					   ?>  
                      ...
                      <div class="form-group">
                        ...
                        id="tanggal_awal" placeholder="Tangal Awal" 
                        data-date-format="dd-mm-yyyy" value="<?php echo $tanggal_awal ?>" 
                        name="tanggal_awal" style="width:150px">
                      </div>
                      <div class="form-group">
...
if($userdata['user_level'] == 3 and $this->pilihan=="B" ) : 
?>
<div class="col-md-3">
    <div class="panel panel-default">
