...
$("#leasing_id").change(function(){
	...
	$.ajax({
		url : '<?php echo site_url("$this->controller/get_data_polda") ?>',
		data  : {leasing_id : $(this).val()},
		type : 'post',
...
$("#selall").click(function(){
	...
	if(this.checked) { // check select status
		 ...
		 $("#btn_cari").click(function(){
				 ...
				 console.log("jenis_permohonan " + $("#jenis_permohonan").val());
				 console.log("id_polda " + $("#id_polda").val());
				 console.log("leasing_id " + $("#leasing_id").val());
				 console.log("tanggal_awal " + tanggal_awal);
				 console.log("anggal_akhir " + tanggal_akhir);
				...
				//alert('oooo.. somebody click me');
				 ...
				 dt
				 .columns(i).search(v)				 
				 .column(1).search($("#jenis_permohonan").val())
				 .column(2).search($("#id_polda").val())
				 .column(3).search($("#leasing_id").val())
