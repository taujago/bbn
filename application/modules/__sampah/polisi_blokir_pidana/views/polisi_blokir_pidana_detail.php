...
.green {
 ...
 <div class="row">
  ...
  <p> <a class="btn btn-lg btn-danger" href="<?php echo site_url("$controller"); ?>" >Kembali </a></p>
 <form id="frm_daftar" >
...
<div class="col-lg-12">
  ...
  <tr>
    <td>Status </td>
    <td>: <?php echo form_dropdown("status",$arr_status,'','id="status"'); ?> <a class="btn btn-primary btn-xs" href="#" onclick="simpan()" >Simpan 
      <input type="hidden" name="daft_id" id="daft_id" value="<?php echo $daft_id; ?>" />
    </a></td>
  </tr>
...
function simpan(){
	...
	$.ajax({
		...
		dataType : 'json',
		data : { status : $("#status").val(), daft_id : $("#daft_id").val()  }, 
