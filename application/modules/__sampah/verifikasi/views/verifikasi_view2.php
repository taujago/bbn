...
<input name="vTGL_DAFTAR" id="vTGL_DAFTAR" class="form-control" type="text" placeholder="Tanggal Pendaftaran" data-date-format="dd-mm-yyyy">
...
<!--<div class="row">
	<div class="col-md-12">
    	<div class="panel-heading">INFORMASI KENDARAAN</div>
...
<!--<div class="row">
  <div id="tbenar" class="col-md-12" >
  <div class="panel-heading">INFORMASI KENDARAAN</div>
        <div class="panel-body">
  <table width="100%" border="0" id="tabel-bpkb" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
  <thead>
  <tr>
    <th width="8%" scope="col">ID </th>
    <th width="42%" scope="col">NO. BPKB</th>
    <th width="22%" scope="col">NO. MESIN</th>
...
<div class="col-md-11">
                        ...
                        <div class="panel-body">
                          <form id="detail_kendaraan" >   
                            ...
                            <ul class="nav nav-tabs ">
                                <li class=""><a aria-expanded="false" href="#home" data-toggle="tab">I. IDENTITAS KENDARAAN</a>
                                </li>
                                <li class="active"><a aria-expanded="true" href="#profile" data-toggle="tab">II. IDENTITAS PEMILIK</a>
                                </li>
    ...
    <table width="100%" border="0" class="table tbdata" >
                                      <tr>
                                        ...
                                        <td width="32%"><input type="text" name="NO_BPKB" id="NO_BPKB" class="form-control" /></td>
