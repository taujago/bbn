...
<form id="frm_cek" method="post">
    ...
    <div class="row">
       <div class="col-md-4">
       		<?php 
				$arr = array(1=>"Nomor Rangka","Nomor BPKB","Nomor Polisi");
				echo form_dropdown("v_is_cari",$arr,'','id="v_is_cari" class="form-control"');
			?>
       </div>
       
       <div class="col-md-4">
       		 <div class="form-group input-group">
            <input name="v_cari" id="v_cari" class="form-control" 
            type="text" placeholder="Masukkan pencarian">
...
<div class="col-md-12">
	<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs ">
                                <li class="active"><a aria-expanded="false" href="#home" data-toggle="tab">I. IDENTITAS KENDARAAN</a>
                                </li>
                                <li><a aria-expanded="true" href="#profile" data-toggle="tab">II. IDENTITAS PEMILIK</a>
                                </li>
    ...
    <table width="100%" border="0" class="table tbdata" >
                                      <tr>
                                        ...
                                        <td width="39%"><input type="text" name="NREG_BPKB" id="NREG_BPKB"  class="form-control" /></td>
                                      </tr>
                                      <tr>
...
<?php $this->load->view("info_view_js"); ?>