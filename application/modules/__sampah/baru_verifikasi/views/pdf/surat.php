...
<table width="100%" border="0">
  ...
  <tr>
    <td width="60%" align="center"><b><img width="70px" height="70px" align="middle" src="<?php  echo FCPATH; ?>/assets/images/logo.png" /><br />
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="1" cellspacing="1">
      <tr>
        <td width="3%">&nbsp;</td>
        <td width="30%">No. Blokir </td>
        <td width="2%">:</td>
        <td width="65%"><?php  echo $no_blokir; ?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>Klasifikasi</td>
...
<table width="100%" border="0" cellpadding="1">
  ...
  <tr>
    ...
    <td  width="95%" valign="top">Rujukan : </td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="3">
      <tr>
        <td width="4%">a.</td>
        <td width="96%" align="justify">Undang - undang no. 22 Tahun 2009 tentang Lalu Lintas dan Angkutan Jalan;</td>
      </tr>
      <tr>
        <td>b.</td>
        <td align="justify">Perkap No. 5 Tahun 2012 tanggal 16 Pebruari 2012 Tentang Registrasi dan Identifikasi Kendaraan Bermotor; </td>
      </tr>
      <tr>
        <td>c.</td>
        <td  align="justify">Surat DIR 
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="left">2</td>
    <td align="justify">Sehubungan dengan rujukan tersebut di atas, bersama ini kami beritahukan bahwa kendaraan bermotor dengan identitas sebagai berikut : </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="left">&nbsp;</td>
    <td><table width="100%" border="0" cellpadding="1" cellspacing="1">
      ...
      <tr>
        <td>Alamat </td>
        <td>:</td>
        <td align="justify"><?php echo $pemilik_alamat; ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="left">&nbsp;</td>
    <td align="justify">Telah dilakukan pemblokiran di seksi BPKB Subdit Regident Dit Lantas  <?php echo ucwords(strtolower($nama_polda_singkatan)); ?> terhitung sejak tanggal <?php echo $tgl_blokir; ?> sampai dengan tanggal <?php echo ($tgl_blokir2); ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="left"><br />
