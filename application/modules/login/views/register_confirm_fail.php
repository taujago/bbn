...
<!-- Begin page content -->
    <div class="container">
      <div class="page-header">
        <h1 class="merah">Link konfirmasi tidak valid</h1>
      </div>
      <p class="lead">Link konfirmasi tidak valid.<br /> Silahkan daftar  <?php echo anchor("login","Kembali"); ?> untuk melanjutkan</p>
